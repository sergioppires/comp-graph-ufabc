...
void Ship::update(const GameData &gameData, float deltaTime) {
  if (gameData.m_state == State::Playing) {
    ...
    m_gravitySpeed += m_gravity * deltaTime;
    m_translation.y += m_gravitySpeed * deltaTime;
...
glm::vec2 Ship::getVelocity() { return m_velocity; }

float Ship::getRotation() { return m_rotation; }
